<?php
/* Smarty version 5.8.0, created on 2026-05-27 09:15:58
  from 'file:edit.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.8.0',
  'unifunc' => 'content_6a16b64e6a7c20_94552097',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2e3e47110617c038b2cae3a71a119f66c3cb0188' => 
    array (
      0 => 'edit.tpl',
      1 => 1779453356,
      2 => 'file',
...
function content_6a16b64e6a7c20_94552097 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = 'C:\\wamp64\\www\\passguard\\passguard\\templates';
$_smarty_tpl->renderSubTemplate("file:head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('page_title'=>"Edit Credential"), (int) 0, $_smarty_current_dir);
...
<div class="page-body">
  ...
  <div class="form-card">
    <form method="POST">
      <input type="hidden" name="id" value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('cred_id'), ENT_QUOTES, 'UTF-8', true);?>
"/>

      <div class="field">
        <label for="site_name">Site Name</label>
        <input type="text" id="site_name" name="site_name"
               value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('v')['site_name'], ENT_QUOTES, 'UTF-8', true);?>
" required/>
      </div>
      <div class="field">
        <label for="site_url">Website URL</label>
        <input type="url" id="site_url" name="site_url"
               value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('v')['site_url'], ENT_QUOTES, 'UTF-8', true);?>
"/>
      </div>
      <div class="field">
        <label for="username">Username / Email</label>
        <input type="text" id="username" name="username"
               value="<?php echo htmlspecialchars((string)$_smarty_tpl->getValue('v')['username'], ENT_QUOTES, 'UTF-8', true);?>
" required/>
      </div>
      <div class="field">
...
?>
            <option <?php if ($_smarty_tpl->getValue('v')['category'] == $_smarty_tpl->getValue('cat')) {?>selected<?php }?>><?php echo $_smarty_tpl->getValue('cat');?>
</option>
          <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
      ...
      <div class="field">
        ...
        <textarea id="notes" name="notes" rows="3"
                  style="resize:vertical;"><?php echo htmlspecialchars((string)$_smarty_tpl->getValue('v')['notes'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
      </div>
